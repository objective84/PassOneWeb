...
namespace PassOne.Domain
{
    ...
    public class PassOneUser : PassOneObject
    {
        ...
        {
            return Id == other.Id && string.Equals(FirstName, other.FirstName) && string.Equals(LastName, other.LastName) && string.Equals(Username, other.Username) && string.Equals(Password, other.Password);
        }
