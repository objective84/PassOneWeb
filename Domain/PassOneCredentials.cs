...
namespace PassOne.Domain
{
    ...
    public class PassOneCredentials : PassOneObject
    {
        ...
        public PassOneCredentials(int id, int user, string title, string url, string un, string email, string pw)
        {
        ...
        public PassOneCredentials(int id, int user, byte[] title, byte[] url, byte[] username, byte[] password, byte[] email)
        {
            Id = id;
